/*-------------------------------
    ...
    changed instances of "Popup and popup" to "Popsup and popsup" respectively to avoid collissions with jQuery mobile popup.
	@author Todd Francis
	@version 2.2.2
-------------------------------*/

;(function(b,t){b.fn.popsup=function(h){var q=this.selector,m=new b.Popsup(h);b(document).on("click.popsup",q,function(n){var k=h&&h.content?h.content:b(this).attr("href");n.preventDefault();m.open(k,void 0,this)});return this.each(function(){b(this).data("popsup",m)})};b.Popsup=function(h){function q(a){var d;b.each(a,function(a,c){if(c)return d=c,!1});return d}function m(a){return"function"===typeof a?"function":a instanceof b?"jQuery":"#"===a.substr(0,1)||"."===a.substr(0,1)?"inline":-1!==b.inArray(a.substr(a.length-
...
function(){g.add(f).remove();f=g=void 0;b(t).unbind("resize",a.center);a.o.hideFlash&&b("object, embed").css("visibility","visible");a.ele&&a.o.activeClass&&b(a.ele).removeClass(a.o.activeClass);var c=b("."+a.o.popsupPlaceholderClass);"inline"==l&&c.length&&c.html(s).removeClass(a.o.popsupPlaceholderClass);l=null;a.o.afterClose.call(a);return a};a.center=function(){f.css(a.getCenter());g.css({height:document.documentElement.clientHeight});return a};a.getCenter=function(){var a=f.children().outerWidth(!0),
